...
class LovableDetector {
  ...
  // ========================================
  // CONVERSATION HISTORY SECTION - EXTRACTED MODULE
  // ========================================
  // Conversation History functionality has been moved to: content_scripts/conversation-history.js
  // Methods are mixed into this class via Object.assign() in the constructor
  //
  ...
  //
  // Available methods (from conversation-history.js):
  ...
  // ========================================
  // CHAT INTERFACE SECTION - EXTRACTED MODULE
  // ========================================
  // Chat Interface functionality has been moved to: content_scripts/chat-interface.js
  // Methods are mixed into this class via Object.assign() in the constructor
  //
  ...
  //
  // Available methods (from chat-interface.js):
  ...
  // - translatePrompt(inputElement, menu)
  // - rewritePrompt(inputElement, menu)
  // - enhancePromptWithHandbook(inputElement, menu)
